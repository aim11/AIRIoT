...
public class XML2RDF extends DefaultHandler{
    ...
    //private static long size = 5 543 358 TRIPLES!
    ...
    public static void main(String[] args)
        ...
        for(int i=start; i<end; i++){
            ...
            XML2RDF handler = new XML2RDF();

            long s = new Date().getTime();

            sp.parse("/home/amaarala/thesis/data/parse/data/incident" + i + ".xml", handler);
    ...
    public void startElement(String uri, String localName,
        ...
        if (qName.equalsIgnoreCase("Coordinates")) {
            ...
            //convert from 6500.00 to 65.0000 & minutes&seconds to decimals
    ...
    private void serializeToRDF(int incident) throws FileNotFoundException {
        ...
        * */
        ...
        while (it.hasNext()) {
            ...
            dataModel.add(obsInstance, distanceType, dataModel.createLiteral(String.valueOf(distance)));
            dataModel.add(obsInstance, accType, dataModel.createLiteral(String.valueOf(estimatedAcc)));
        ...
        FileOutputStream fstream = new FileOutputStream("/home/amaarala/thesis/data/obs_data_rdf_ntriple/incident_"+incident+".nt");
        dataModel.write(fstream, "N-TRIPLES");
        try {
            fstream.close();
        } catch (IOException e) {
            e.printStackTrace();
       ...
       /*ioTReasoner.getReasoner().initDataModel(dataModel);
        ...
        //ioTReasoner.updateSesameRepository(dataModel);
